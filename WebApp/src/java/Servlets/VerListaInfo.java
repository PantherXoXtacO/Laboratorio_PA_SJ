 ...
 * @author Usuario
 */
@WebServlet(name = "VerListaInfo", urlPatterns = {"/VerListaInfo"})
public class VerListaInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
            ...
            if(l!=null){
                ...
                out.println("<html><body onload=\"alert('Error interno :(')\"></body></html>");
